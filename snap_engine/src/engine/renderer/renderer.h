...
public:
	...
	static void render_line(const glm::vec2& start, const glm::vec2& end, const color& color, f32 lineWidth = 1.0f); // broken function
	static void render_wideline(const glm::vec2& start, const glm::vec2& end, const color& color, f32 lineWidth = 1.0f);
